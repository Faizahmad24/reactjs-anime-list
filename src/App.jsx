...
export default function App() {
  ...
  return (
    <>
      {/* <Navbar animes={animes} filteredItem={handleSearchItem} query={query} setQuery={setQuery}/> */}
      <Navbar>
        {/* <Search animes={animes} filteredItem={handleSearchItem} query={query} setQuery={setQuery}/> */}
        <Search filteredItem={handleSearchItem} query={query} setQuery={setQuery}>
